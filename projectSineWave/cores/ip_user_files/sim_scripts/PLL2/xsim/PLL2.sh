...
#
# Generated by Vivado on Fri Jun 19 18:10:56 +0200 2020
...
# Script info
echo -e "PLL2.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PLL2 xil_defaultlib.PLL2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PLL2 -key {Behavioral:sim_1:Functional:PLL2} -tclbatch cmd.tcl -log simulate.log
}
