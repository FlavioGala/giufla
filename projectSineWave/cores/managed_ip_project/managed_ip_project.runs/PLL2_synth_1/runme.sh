...
HD_PWD='C:/Users/Garripoli/Desktop/giufla/projectSineWave/cores/managed_ip_project/managed_ip_project.runs/PLL2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PLL2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PLL2.tcl
